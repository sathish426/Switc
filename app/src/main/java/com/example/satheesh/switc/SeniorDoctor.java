...
public class SeniorDoctor extends AppCompatActivity {
   ...
   TextView btnsave,btnnext,btnprev;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senior_doctor);
       ...
       btnprev=(TextView)findViewById(R.id.prev);
...
// Later at some point, e.g. when camera is closed:
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isNextsave==true){
                    AlertDialog alertDialog = new AlertDialog.Builder(SeniorDoctor.this).create();
